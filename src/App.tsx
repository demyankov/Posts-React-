              ...
              <Routes>
                <Route path="/" element={<MainLayout />}>
                  ...
                  <Route
                    ...
                    element={<Information informationData={informationData} />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<RequestResertPassword />}
                  />
                  <Route
                    path={`${AppRoute.ResertPasswordConfirm}/:uid/:token`}
                    element={<NewPassword />}
                  />
                  <Route
                    path={AppRoute.PostsPage}
                    element={
                      <PrivateRouter>
                        <PostsPage title="All posts" />
                      </PrivateRouter>
                    }
                  />
                  <Route
                    path={AppRoute.MyPostsPage}
                    element={
                      <PrivateRouter>
                        <PostsPage title="My posts" isMyPosts />
                      </PrivateRouter>
                    }
                  />
                  <Route
                    path={`${AppRoute.PostsPage}/:postId`}
                    element={
                      <PrivateRouter>
                        <PostsPage title="Post" btnText="Back" />
                      </PrivateRouter>
                    }
                  />
                  <Route
                    path={`${AppRoute.MyPostsPage}/:postId`}
                    element={
                      <PrivateRouter>
                        <PostsPage title="Post" btnText="Back" />
                      </PrivateRouter>
